...
(() => {
    ...
    if (platform === "sleeper") {
        ...
        const sleeperScan = () => {
            ...
            const nodes = document.querySelectorAll('[class*="pick"], [class*="Pick"], [data-testid*="pick"]');
            nodes.forEach((el) => {
                const htmlEl = el;
            ...
            const s = window.__SLEEPER_DRAFT_STATE__;
                    ...
                    forward({
                        ...
                        event: {
                            ...
                            payload: {
                                ...
                                player_name: p.player && p.player.first_name
